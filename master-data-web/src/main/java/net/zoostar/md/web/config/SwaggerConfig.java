...
public class SwaggerConfig {
	...
	@Value("${request.handler.selectors.base.package:net.zoostar.md.web.controller.api}")
	public void setRequestHandlerSelectorsBasePackage(String requestHandlerSelectorsBasePackage) {
    	log.debug("requestHandlerSelectorsBasePackage: {}", requestHandlerSelectorsBasePackage);
	...
	protected ApiInfo getApiInfo() {
		return new ApiInfo("Master Data", "Application for Master Data CRUD Operations",
				"1.0.0", "", new Contact("Zoostar Consulting, Inc.", "", ""),
